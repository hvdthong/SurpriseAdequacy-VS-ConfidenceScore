...
class DefectNet(nn.Module):
    def __init__(self, args):
        ...
        # Uncertainty
        self.uncertainty1 = nn.Linear(2 * len(Ks) * Co, args.hidden_units)
        self.uncertainty2 = nn.Linear(args.hidden_units, 10)        
        self.uncertainty3 = nn.Linear(10, 1)
    ...
    def forward(self, msg, code):
        ...
        uncertainty = F.relu(self.uncertainty1(x_commit))
        uncertainty = F.relu(self.uncertainty2(uncertainty))
        uncertainty = self.uncertainty3(uncertainty)    
